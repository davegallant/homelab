...
| docker.io/dgtlmoon/changedetection.io | 0.60.3 |
| docker.io/docker | 29.8.0-dind |
| docker.io/fosrl/newt | 1.16.0 |
| docker.io/gotify/server | 3.1.0 |
| docker.io/grafana/grafana | 13.2.1 |
| docker.io/grafana/loki | 3.7.7 |
| docker.io/henrygd/beszel | 0.19.0 |
| docker.io/itzg/minecraft-bedrock-server | 2026.8.2 |
| docker.io/jellyfin/jellyfin | 12.0 |
...
| docker.io/mariadb | 12.3.3 |
| docker.io/miniflux/miniflux | 2.3.3 |
| docker.io/paperlessngx/paperless-ngx | 3.1.3 |
| docker.io/postgres | 18.6 |
| docker.io/rommapp/romm | 5.2.0 |
| docker.io/searxng/searxng | 2026.9.7-3e454637f |
...
| ghcr.io/seriousm4x/upsnap | 5.6.0 |
| ghcr.io/umami-software/umami | 3.3.1 |
| quay.io/invidious/invidious | 2026.08.28-b3a3f3a |
| quay.io/invidious/invidious-companion | 2026.09.05-6049c32 |
<!-- DOCKER_SERVICES_END -->
